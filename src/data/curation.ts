...
export const featured: Partial<Record<Category, string[]>> = {
  'branding': ['amtec-60-identity--1', 'inspire', 'cali-type', 'zr-monogram--0', 'zr-monogram--1', 'tristaff-identity--0', 'hypersonic-staffing', 'rooted-roots', 'csp-member', 'bee-podcast', 'revd-up', 'hiring-scott--0'],
