...
export const featured: Partial<Record<Category, string[]>> = {
  'branding': ['set-logo-presentation', 'set-brand-style-guide-12-pages', 'rebuild-skills-identity', 'willow-circle-identity', 'seahorse-identity', 'set-in-your-prime-primary-mark', 'set-brand-presentation', 'clearly-filtered-brand-board', 'set-johnny-s-mobile-detail-full-lockup', 'set-anniversary-mark', 'hypersonic-staffing', 'inspire', 'zr-monogram--1', 'csp-member', 'bee-podcast', 'revd-up', 'hiring-scott--0', 'set-blackmagic-collective-circular-badge', 'set-mic-drop-primary-mark', 'set-badge-lettering', 'set-alternate-lockup', 'set-mark-first-direction'],
