...
export const work: WorkItem[] = [
  ...
  /* --------------------------- Client brand work --------------------------- */
  {
    ...
    slides: [
      ...
      { src: img('evergreen-05-overlay-1.jpg'), caption: '“Go to Grow” lockup' },
      { src: img('evergreen-06-overlay-2.jpg'), caption: '“Go 2 Grow” lockup' },
      { src: img('evergreen-07-overlay-2-1.png'), caption: '“Go 2 Grow” lockup, alternate' },
      { src: img('evergreen-08-overlay-3.jpg'), caption: '“Go & Grow” lockup' },
      { src: img('evergreen-09-overlay-3-1.png'), caption: '“Go & Grow” lockup, alternate' },
      { src: img('evergreen-10-overlay-4.jpg'), caption: '“Go 2 Grow” banner lockup' },
      { src: img('evergreen-11-insta-overlay-logomark-mu.jpg'), caption: 'Instagram — logomark' },
      { src: img('evergreen-12-insta-overlay-1-mu.jpg'), caption: 'Instagram — “Go to Grow”' },
      { src: img('evergreen-13-insta-overlay-2-1-mu.jpg'), caption: 'Instagram — “Go 2 Grow”' },
      { src: img('evergreen-14-insta-overlay-3-1-mu.jpg'), caption: 'Instagram — “Go & Grow”' },
      { src: img('evergreen-15-insta-overlay-4-mu.jpg'), caption: 'Instagram — banner lockup' },
      {
        doc: [
        ...
        caption: 'Evergreen brand style guide',
      },
    ],
  },
  {
