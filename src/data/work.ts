...
export const work: WorkItem[] = [
  /* ----------------------------- Graphic Design ---------------------------- */
  {
    ...
    slides: [
      ...
      { src: img('bilflo-y-01-bilflo-banner-mockup-d1.png'), caption: 'Trade-show banner' },
  ...
  /* ------------------------------ Web / UI --------------------------------- */
  {
    ...
    slides: [
      ...
      { src: img('bilflo-app-y-01-bilflo-before-d3.png'), caption: 'The back-office it replaced' },
    ],
  },
  {
    id: 'amtec-60-web',
